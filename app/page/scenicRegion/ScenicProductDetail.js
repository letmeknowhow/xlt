...
const LIST_DETAIL=[
  {id: '1',price:'¥198', starting:'北京出发',time:'2016.12.15、2017.1.1',
    title:'河南云台山景区成人票',
    details:'云台山 自由行',
    picUrl: require('../../../assets/journey/mountain.jpg')}
];
const TUIJIAN=[
  { id: '1',
    title:'想去湛池的人还想去',
...
export default class ScenicProductDetail extends Component {
  // 默认属性
  static defaultProps = {};
